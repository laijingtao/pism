...
#ifndef _PSAVALANCHE_H_
#define _PSAVALANCHE_H_
...
class Avalanche : public SurfaceModel {
public:
  Avalanche(IceGrid::ConstPtr g, std::shared_ptr<SurfaceModel> in);
private:
