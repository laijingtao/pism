...
protected:
  bool do_glacial_erosion = false, do_prescribed_uplift = false, do_fluvial = false;
  IceModelVec2S m_prescribed_uplift, m_accum_glacial_erosion, m_accum_fluvial_erosion;
  ...
  void compute_glacial_erosion_threshold(const std::string &stabilizing_method,
